...
parser.add_argument("--cfg_level", type=str, default="mid",
                    choices=["mid", "hard"])
...
kitchen_config_1 = {
    ...
    "objects": [
        ...
        },
        {
            ...
            "position": {
                "xy_limit": [[1.933/kitchen_config_1_env_size, 0.85/kitchen_config_1_env_size], 
                            [1.943/kitchen_config_1_env_size, 0.851/kitchen_config_1_env_size]], 
            },
            "rotation": {
                "type": "uniform_z",
                "lower": -0.00001,
...
print("bench mark result will be saved to ", 
      os.path.join(benchmark_dir, f"benchmark_{args.num_envs:05d}.csv"))
